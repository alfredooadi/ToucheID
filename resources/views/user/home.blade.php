...
@section('hero')
    <h1>TOUCHE Development Center</h1>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
              <div class="box">
                ...
                <p class="description">TOUCHE dibangun berdasarkan kepercayaan. TOUCHE ingin klien aman dan nyaman untuk berbagi bersama kami.</p>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
              <div class="box">
                ...
                <p class="description">Klien ditangani hanya oleh profesional berlisensi, baik psikolog, konselor, terapis, maupun trainer.</p>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
              <div class="box">
                ...
                <p class="description">Klien adalah prioritas utama TOUCHE. Perkembangan menuju diri yang optimal adalah tujuan utama TOUCHE berdiri.</p>
              </div>
            </div>
          </div>
        ...
        <div class="container wow fadeIn">
          <div class="row">
            ...
            <div class="col-lg-3 cta-btn-container text-center">
              <a class="cta-btn align-middle" href="/blog">BLOG</a>
            </div>
          </div>
